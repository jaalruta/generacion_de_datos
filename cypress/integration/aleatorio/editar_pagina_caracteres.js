...
describe ('editar pagina con caracteres', function(){
    beforeEach(() => {
    ...
    it ('login', function(){
      ...
      cy.get('.gh-editor-title.ember-text-area.gh-input.ember-view').scrollIntoView().focus().type(faker.datatype.string(15));
      cy.wait(2000);
      
      cy.get('.koenig-editor__editor.__mobiledoc-editor').type(faker.datatype.string(15));
      cy.wait(2000);
