...
describe ('Invitar staff con correo con caracteres', function(){
    beforeEach(() => {
    ...
    it ('invitar staff', function(){
        ...
        cy.wait(2000);
        cy.get('#new-user-email').type(faker.internet.email(faker.random.words(4), faker.random.words(5), 'ghost.com', { allowSpecialCharacters: true }));;
        cy.wait(2000);
